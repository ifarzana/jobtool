					...
					<div class="cipanel">
						...
						<div class="cipanel-title">
							<div class="cipanel-tools">
								...
								<a href="<?php echo UrlHelper::getUrl($controller, $action, array('id' => $user->id)); ?>"
							...
							<div class="table-responsive">
								<table class="table table-hover">
									...
									<tr>
										...
										<th> <a href="<?php echo UrlHelper::getUrl($controller, $action, $paginationData, array('order_by' => 'client_id'), true); ?>">Client <?php if ($order_by == 'client_id'): ?><i class="fa fa-caret-<?php echo $url_order == 'ASC' ? 'down' : 'up' ?>"></i><?php endif; ?></a></th>
									...
									<tbody>
										@foreach ($results as $result)
											...
											<tr>
												...
												<td><span class="bold">{{ $result->client->name }}</span></td>
