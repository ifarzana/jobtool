									...
									<div id="context-menu-items-fg" class="row">
										...
										<div class="col-md-12">
											<div class="form-group<?php if($errors->has('schedule_context_menu_items')){ echo "has-error";} ?>">
												...
												{!! Form::select('schedule_context_menu_items[]', $context_menu_items, json_decode($result->schedule_context_menu_items), ['id' => 'schedule_context_menu_items', 'class'=>'form-control', 'data-placeholder' => 'Please choose', 'multiple', 'disabled', $readonly]) !!}
											</div>
										</div>
									...
									<div class="row">
										...
										<div class="col-md-6">
											<div class="form-group <?php if($errors->has('schedule_weekend_days')){ echo "has-error";} ?>">
												...
												{!! Form::select('schedule_weekend_days[]', $weekend_days, json_decode($result->schedule_weekend_days), ['class'=>'form-control', 'data-placeholder' => 'Please choose', 'multiple', 'disabled', $readonly]) !!}
											</div>
										</div>
										<div class="col-md-6">
											<div class="form-group <?php if($errors->has('schedule_business_hours')){ echo "has-error";} ?>">
												...
												<div class="input-group">
													{!! Form::select('schedule_business_hours_from_time[]', $business_hours, json_decode($result->schedule_business_hours_from_time), ['class'=>'form-control', 'data-placeholder' => 'Please choose', 'single', 'disabled', $readonly]) !!}
													<span class="input-group-addon">to</span>

													{!! Form::select('schedule_business_hours_to_time[]', $business_hours, json_decode($result->schedule_business_hours_to_time), ['class'=>'form-control', 'data-placeholder' => 'Please choose', 'single', 'disabled', $readonly]) !!}
												</div>
											</div>
										</div>
